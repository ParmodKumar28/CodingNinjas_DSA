...
// Diameter of a Tree
// The diameter of a tree can be defined as the maximum distance between two
// leaf nodes.
...
// The distance is 9 as there are a total of nine nodes along the longest path
// from 8 to 9(inclusive of both). Hence the diameter according to the
// definition will be 9.
// Input Format:
...
// data.
// Output Format:
// The only line of output prints an integer, representing the diameter of the
// tree.
// Note:
