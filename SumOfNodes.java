// Sum Of Nodes
// Send Feedback
// For a given Binary Tree of integers, find and return the sum of all the nodes
// data.
// Example:
// ALTIMAGE

// When we sum up all the nodes data together, we get 150. Hence, the output
// will be 150.
// Input Format:
...
// data.
// Output Format:
// The first and the only line of output prints the sum of all the nodes data
...
// 15
// Explanation :
// The binary tree formed using the input values: 2, 3, 4, 6, -1, -1, -1, -1,
// -1. Hence the sum is 15.
// ALTIMAGE
