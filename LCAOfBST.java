// LCA of BST
// Send Feedback
// Given a binary search tree and data of two nodes, find 'LCA' (Lowest Common
// Ancestor) of the given two nodes in the BST.
// LCA
// LCA of two nodes A and B is the lowest or deepest node which has both A and B
// as its descendants.
// Example:
...
// Note:
// It is defined that each node is a descendant to itself, so, if there are two
// nodes X and Y and X has a direct connection from Y, then Y is the lowest
// common ancestor.
// Example:
// Alt Text
...
// The following line of input contains two integers, denoting the value of data
// of two nodes of given BST.
// Output Format:
